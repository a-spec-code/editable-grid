...
module.exports = {
     ...
     */
    calculateAmountOfColumns: function (view, columns, startIndex) {
        var counter = 0,
            total = 0;

        for (var c = startIndex; c < columns.length; c++) {
     ...
     * @param Array records
     */
    canFitRows: function (view, records) {
        var totalRowCountRequired = records.length * view.TR_HEIGHT;
        return totalRowCountRequired <= view.TBODY_HEIGHT;
    },

    /**
     * Calculate the amount of rows that fit into the view.
     * @param Object view
     */
    calculateAmountOfRows: function (view) {
