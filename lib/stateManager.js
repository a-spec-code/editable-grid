 ...
 */
var stateManager = function (data, ears, options) {
    this._data = data;
    this._ears = ears;
...
stateManager.prototype = {
     ...
     * @event fires namespace.value-updated with
     *  {
     *      record: Object,
     *      recordId: String,
     *      propertyName: String,
    ...
    setRecordValue: function (record, name, value) {
        ...
        this._ears.trigger('value-updated', {
            record: record,
            recordId: record[this._options.id],
            propertyName: name,
            value: value
        });
    },
    ...
    addRecord: function (record, position) {
        ...
        this._ears.trigger('new-record', record);
        return record;
    },
