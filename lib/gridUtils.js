...
module.exports = function (options) {
    ...
    var utils = {
        ...
        _replaceFooterRow: function (colId) {

            // data
            var data = options.rows.newRowData(this._getNewRowData());

            // find new row
            var tr = options.el.find('.booty-footer-table tr.new-row');

            // replace footer row
            var newRow = $(rowFactory.createTableFooterAddRow(
                {
            ...
            newRow.find('td[data-col-id="' + colId + '"] input, ' +
                'td[data-col-id="' + colId + '"] select').focus();
        },
